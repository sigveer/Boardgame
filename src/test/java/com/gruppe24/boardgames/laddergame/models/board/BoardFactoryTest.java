...
class BoardFactoryTest {
   ...
   * This test checks if the factory correctly creates an instance of {@code Board}.
   */
  @Test
  ...
  /**
   * Tests the creation of a board with a null board type.
   * This test checks if the factory throws an exception when a null board type is provided.
   */
  @Test
